...
func resourceAppUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	if d.HasChange("service_binding") || d.HasChange("stopped") || d.HasChange("route") || d.HasChange("url") || d.HasChange("git") || d.HasChange("docker_image") || d.HasChange("git") || d.HasChange("github_release") || d.HasChange("add_content") {
